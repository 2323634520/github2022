...
<main>
    <div class="container">
        ...
        <form class="form" action="${pageContext.request.contextPath}/Student/studentLogin" method="post" id="loginForm">
            <h3>算法工作室管理系统</h3>
            ...
            <button type="button" id="btn" onclick="confirm(${"确认面部识别"})">面部识别</button>
        </form>
    </div>
</main>
...
<script type="text/javascript">
    ...
    $("#btn").click(function () {
        window.location.href = '${pageContext.request.contextPath}/Student/faceLoginPage';
    });
</script>
</html>
